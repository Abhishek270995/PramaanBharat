...
export const SOLVED_ARCHIVED_CASES: SolvedArchivedCase[] = [
  {
    id: 'CASE-2026-KA-9914',
    firNumber: 'FIR/0512/2026/BLR-CYBER',
    maskedFirNumber: 'FIR/0512/2026/BLR-***',
    stateId: 'karnataka',
    stateName: 'Karnataka',
    districtId: 'bengaluru-urban',
    districtName: 'Bengaluru Urban & Tech Corridors',
    policeStation: 'Cyber Crime Police Station, CID HQ Bengaluru',
    investigatingOfficer: 'SP Raghavendra Rao',
    officerBadge: 'KA-CID-9912',
    category: 'Cybercrime & Online Fraud',
    title: 'AI Deepfake Voice Spoofing & Corporate Wire Scam Dismantled',
    incidentDate: '2026-08-19',
    solvedDate: '2026-08-20',
    archivedDate: '2026-08-20',
    summary: 'Syndicate cloning executive voice notes to induce finance heads to execute urgent offshore vendor wires intercepted within 3 hours by Cyber Command.',
    policeActionTaken: 'Real-time 1930 portal freeze triggered across 14 beneficiary bank accounts. 4 technical handlers arrested in Electronic City raid.',
    recoveryDetails: '₹2.85 Crores retrieved in mule bank liens; 100% frozen before offshore wire transfer.',
    convictionStatus: 'Chargesheet Filed - Fast Track Court',
    accusedCount: 4,
    evidenceTags: ['Voice Biometric Spectral Analysis', 'Frozen Mule Accounts', 'Encrypted Server Logs'],
    confidentialForensicBrief: 'Voice synthesis model cloned from public podcast audio. CFSL deepfake forensic confidence: 99.8%.',
    isRestrictedClassified: true
  },
  {
    id: 'CASE-2026-TG-9821',
    firNumber: 'FIR/0289/2026/RCK-EOW',
    maskedFirNumber: 'FIR/0289/2026/RCK-***',
    stateId: 'telangana',
    stateName: 'Telangana',
    districtId: 'hyderabad',
    districtName: 'Hyderabad (Cyberabad & Rachakonda)',
    policeStation: 'Economic Offences Wing, Rachakonda Police Commissionerate',
    investigatingOfficer: 'DCP K. Sandeep Kumar',
    officerBadge: 'TG-IPS-4421',
    category: 'Financial & Corporate Fraud',
    title: 'Inter-State E-Way Bill & Bogus Input Tax Credit (ITC) Circular Trading Ring Neutralized',
    incidentDate: '2026-08-18',
    solvedDate: '2026-08-20',
    archivedDate: '2026-08-20',
    summary: 'Cartel operating 38 bogus shell entities to generate fake GST e-way bills without physical movement of scrap metal busted across Telangana and Maharashtra.',
    policeActionTaken: 'Joint operation with State Commercial Tax Vigilance. Seized digital tokens, forged rubber stamps, and 19 point-of-sale card terminals.',
    recoveryDetails: '₹9.4 Crores in fake invoice disbursements attached; 5 shell firm premises sealed.',
    convictionStatus: 'Chargesheet Filed - Fast Track Court',
    accusedCount: 7,
    evidenceTags: ['E-Way Bill GPS Telematics', 'Fake Shell Registrations', 'Forged Lorry Receipts'],
    confidentialForensicBrief: 'Fastag toll plaza vehicle match logs proved physical trucks were over 1,200 km away during alleged transit timestamps.',
    isRestrictedClassified: true
  },
  {
    id: 'CASE-2026-MH-9734',
    firNumber: 'FIR/0641/2026/PUN-CYBER',
    maskedFirNumber: 'FIR/0641/2026/PUN-***',
    stateId: 'maharashtra',
    stateName: 'Maharashtra',
    districtId: 'mumbai-city',
    districtName: 'Mumbai City & Suburban',
    policeStation: 'Cyber Crime Police Station, Shivajinagar, Pune',
    investigatingOfficer: 'ACP Pratibha Joshi',
    officerBadge: 'MH-POL-8819',
    category: 'Cybercrime & Online Fraud',
    title: 'Instant Loan APK Blackmail & Morphed Photos Extortion Ring Neutralized',
    incidentDate: '2026-08-16',
    solvedDate: '2026-08-20',
    archivedDate: '2026-08-20',
    summary: 'Predatory lending apps harvesting contact lists and photo galleries to blackmail borrowers with morphed images shut down.',
    policeActionTaken: 'Pune Cyber Cell mapped remote call center operations in Thane and arrested 11 callers and supervisors. Seized 32 VoIP terminals.',
    recoveryDetails: '₹3.2 Crores in extortion proceeds frozen; domain hosting clusters taken down via CERT-In directive.',
    convictionStatus: 'Chargesheet Filed - Fast Track Court',
    accusedCount: 11,
    evidenceTags: ['VoIP Audio Call Logs', 'Malicious APK Source Code', 'Payment Gateway Hash Keys'],
    confidentialForensicBrief: 'APK malware extracted device contacts during install permissions bypass. Security patch released to telecom app stores.',
    isRestrictedClassified: false
  },
  {
    id: 'CASE-2026-TN-9620',
    firNumber: 'FIR/0188/2026/CHN-TRAFFIC',
    maskedFirNumber: 'FIR/0188/2026/CHN-***',
    stateId: 'tamil-nadu',
    stateName: 'Tamil Nadu',
    districtId: 'chennai',
    districtName: 'Chennai Metropolitan',
    policeStation: 'Traffic Investigation Wing, Anna Salai, Chennai',
    investigatingOfficer: 'Inspector V. Balasubramanian',
    officerBadge: 'TN-POL-5510',
    category: 'Public Order & Nuisance',
    title: 'ANPR AI Smart Highway Hit-and-Run Tracking Case Solved in 4 Hours',
    incidentDate: '2026-08-19',
    solvedDate: '2026-08-20',
    archivedDate: '2026-08-20',
    summary: 'Commercial vehicle causing early morning accident on GST Road identified and impounded using high-speed ANPR camera network within 4 hours.',
    policeActionTaken: 'AI license plate recognition cross-referenced 12,000 toll transit records across 4 district border checkpoints.',
    recoveryDetails: 'Offending vehicle seized; ₹15 Lakhs statutory third-party insurance compensation initiated for victim family.',
    convictionStatus: 'Chargesheet Filed - Fast Track Court',
    accusedCount: 2,
    evidenceTags: ['ANPR Optical Plate Match', 'Toll Plaza Video Stills', 'GPS Speed Telemetry'],
    confidentialForensicBrief: 'Optical sensor matched partially damaged front bumper debris with on-site physical accident evidence.',
    isRestrictedClassified: false
  },
  {
    id: 'CASE-2026-WB-9012',
    firNumber: 'FIR/0382/2026/LALBAZAR-CENTRAL',
    maskedFirNumber: 'FIR/0382/2026/LALBAZAR-***',
    stateId: 'west-bengal',
    stateName: 'West Bengal',
    districtId: 'kolkata',
    districtName: 'Kolkata Central & Metro',
    policeStation: 'New Market Police Station & Lalbazar Detective Dept',
    investigatingOfficer: 'Deputy Commissioner S. K. Banerjee',
    officerBadge: 'WB-IPS-1092',
    category: 'Public Order & Nuisance',
    title: 'Mirza Galib Commercial Safety & Electrical Conduit Violations Case Closed',
    incidentDate: '2026-08-19',
    solvedDate: '2026-08-19',
    archivedDate: '2026-08-19',
    summary: 'Joint inspection by West Bengal Fire Services & Lalbazar Detective Department sealed hazardous commercial premises and filed statutory charges under BNS Sections 106/287.',
    policeActionTaken: 'High-level forensic team seized electrical conduit logs and commercial license records. Statutory FIR filed and building sealed.',
    recoveryDetails: '₹1.4 Crores in safety compliance bank guarantees attached; building sealed per court order.',
    convictionStatus: 'Chargesheet Filed - Fast Track Court',
    accusedCount: 3,
    evidenceTags: ['Forensic Electrical Scan', 'Fire Safety Audit Report', 'CCTV DVR Footage'],
    confidentialForensicBrief: 'Forensic team confirmed non-compliant circuit load wiring. Departmental directive issued to all municipal wards.',
    isRestrictedClassified: false
  },
  {
    id: 'CASE-2026-DL-8819',
    firNumber: 'FIR/0142/2026/ACB-HQ',
    maskedFirNumber: 'FIR/0142/2026/ACB-***',
    stateId: 'delhi-ncr',
    stateName: 'Delhi NCR',
    districtId: 'new-delhi',
    districtName: 'New Delhi Central',
    policeStation: 'Anti-Corruption Branch HQ, Vikas Bhawan',
    investigatingOfficer: 'Joint Commissioner M. P. Sharma',
    officerBadge: 'DL-ACB-4491',
    category: 'Financial & Corporate Fraud',
    title: 'Delhi Jal Board Sewage Treatment Plant Tender Irregularities Syndicate Neutralized',
    incidentDate: '2026-08-18',
    solvedDate: '2026-08-19',
    archivedDate: '2026-08-19',
    summary: 'Multi-crore cartel bidding and forged technical audit certifications in sewage treatment plant upgrades uncovered across 12 locations.',
    policeActionTaken: 'ACB conducted simultaneous coordinated raids seizing encrypted financial ledgers and bank transaction records; 6 key orchestrators remanded to custody.',
    recoveryDetails: '₹6.2 Crores in bogus tender disbursements frozen across 22 private consultancy accounts.',
    convictionStatus: 'Chargesheet Filed - Fast Track Court',
    accusedCount: 6,
    evidenceTags: ['Encrypted Ledgers', 'Digital Transaction Logs', 'Forged Stamp Audits'],
    confidentialForensicBrief: 'Digital signatures verified with National Informatics Centre (NIC) database confirming falsified approvals.',
    isRestrictedClassified: true
  },
  {
...
export const LIVE_SAFETY_ALERTS: LiveSafetyAlert[] = [
  {
    id: 'ALERT-20260819-01',
    title: 'Kolkata Police & Fire Services: Commercial Hospitality Fire Audits Enforced Following Mirza Galib St Blaze',
    description: 'All hotels, guest houses, and commercial buildings across central Kolkata ordered to verify emergency exits, sprinkler lines, and electrical conduits. Joint teams of Kolkata Police & Fire Services conducting active on-ground inspections.',
    severity: 'Critical',
    stateId: 'west-bengal',
    districtId: 'kolkata',
    locationName: 'Mirza Galib St & Central Kolkata Hubs',
    issuedBy: 'West Bengal Fire Services & Kolkata Police HQ (Lalbazar)',
    timestamp: '12 mins ago',
    expiresAt: 'Active Statutory Inspection for next 72 hours',
    category: 'Public Order & Nuisance',
    activeHelpline: '101 (Fire) / 112 (Emergency)',
    isPinned: true
  },
  {
    id: 'ALERT-20260819-02',
    title: 'I4C & MHA National Cyber Alert: Fake Digital Arrest & Video Extortion Impersonating Judges',
    description: 'MHA Indian Cyber Coordination Centre (I4C) flags nationwide syndicates staging fake police stations on video calls. Law enforcement NEVER conducts digital arrests or demands money transfers on Skype/WhatsApp. Report immediately on 1930.',
    severity: 'Critical',
    stateId: 'delhi-ncr',
    districtId: 'new-delhi',
    locationName: 'All India National Advisory (I4C)',
    issuedBy: 'Indian Cyber Coordination Centre (I4C), MHA',
    timestamp: '25 mins ago',
    expiresAt: 'Active 24x7 Nationwide Protocol',
    category: 'Cybercrime & Online Fraud',
    activeHelpline: '1930 (National Cybercrime) / cybercrime.gov.in',
    isPinned: true
  },
  {
    id: 'ALERT-20260819-03',
    title: 'Delhi Traffic Police Advisory: Central Delhi Lutyens Corridor Traffic Regulated',
    description: 'Special administrative convoys and monsoon drainage upgrades along Ashoka Road & Janpath. Commuters advised to utilize Ring Road and Delhi Metro for peak-hour transit.',
    severity: 'Advisory',
    stateId: 'delhi-ncr',
    districtId: 'new-delhi',
    locationName: 'Central & New Delhi Corridor',
    issuedBy: 'Delhi Traffic Police Command Centre',
    timestamp: '38 mins ago',
    expiresAt: 'Valid till 22:00 IST',
    category: 'Traffic Hazard',
    activeHelpline: '011-25844444 / 112',
    isPinned: false
  },
  {
    id: 'ALERT-20260819-04',
    title: 'IMD & Disaster Red Alert: Deep Depression & Heavy Inundation Forecast in Coastal Belts',
    description: 'Squally wind speeds up to 60 km/h with localized flash flood warnings. Fishermen advised not to venture into sea. District emergency response teams deployed across coastal corridors.',
    severity: 'Warning',
    stateId: 'tamil-nadu',
    districtId: 'chennai',
    locationName: 'Coastal Tamil Nadu, Kerala & Maharashtra',
    issuedBy: 'India Meteorological Department (IMD) & SDRF',
    timestamp: '50 mins ago',
    expiresAt: 'Active for next 48 hours',
    category: 'Disaster',
    activeHelpline: '1070 (State Disaster) / 1077',
    isPinned: false
  },
  {
    id: 'ALERT-20260819-05',
    title: 'Bengaluru Traffic Police (BTP): Silk Board & Bellandur Sump Pumping Traffic Advisory',
    description: 'Monsoon runoff drainage on Outer Ring Road service lines. Heavy vehicles restricted during morning and evening rush hours. Use designated peripheral flyovers.',
    severity: 'Advisory',
    stateId: 'karnataka',
    districtId: 'bengaluru-urban',
    locationName: 'Outer Ring Road & Bellandur, Bengaluru',
    issuedBy: 'Bengaluru Traffic Police (BTP)',
    timestamp: '1 hour ago',
    expiresAt: 'Expected clearance by 23:00 IST',
    category: 'Traffic Hazard',
    activeHelpline: '080-22942222 / 1073',
    isPinned: false
  },
  {
    id: 'ALERT-20260819-06',
    title: 'Bihar Food Safety & Public Health Alert: Mandatory Mid-Day Meal Pantry Chemical Checks',
    description: 'Saran DM & Bihar Health Dept order strict segregation of cleaning materials from food preparation zones across all district schools following recent hospitalization incident.',
    severity: 'Warning',
    stateId: 'bihar',
    districtId: 'patna',
    locationName: 'Saran, Patna Rural & Chapra (Bihar)',
    issuedBy: 'Bihar State Health & Disaster Management Dept',
    timestamp: '2 hours ago',
    expiresAt: 'Active District Directive',
    category: 'Public Order & Nuisance',
    activeHelpline: '112 / 0612-2217300',
    isPinned: false
  },
  {
    id: 'ALERT-20260819-07',
    title: 'Cyberabad Police IT Corridor Advisory: 24/7 Smart "She Shuttle" & GPS Panic Telematics',
    description: 'Dedicated fleet of 40 electric smart shuttles with live police telematics operating across Gachibowli, Raidurgam & Financial District for night commuters. Track and board via safe transit app.',
    severity: 'Advisory',
    stateId: 'telangana',
    districtId: 'hyderabad',
    locationName: 'Financial District, Gachibowli & Madhapur, Hyderabad',
    issuedBy: 'Cyberabad Police Commissionerate & SCSC',
    timestamp: '2 hours ago',
    expiresAt: 'Continuous 24x7 Night Protocol (9 PM - 6 AM)',
    category: 'Women & Child Safety',
    activeHelpline: 'She Teams WhatsApp: 9490616555 / 112',
    isPinned: false
  },
  {
    id: 'ALERT-20260819-08',
    title: 'Maharashtra Cyber Alert: Fraudulent Stock Market & High-Return Telegram Channels',
    description: 'Cyber cell warns against unsolicited investment groups offering fake pre-allotment institutional shares. Never share banking OTPs or transfer funds to personal savings accounts.',
    severity: 'Warning',
    stateId: 'maharashtra',
    districtId: 'mumbai-city',
    locationName: 'Mumbai, Pune & Thane Metropolitan',
    issuedBy: 'Maharashtra Cyber Crime HQ',
    timestamp: '3 hours ago',
    expiresAt: 'Active Financial Advisory',
    category: 'Cybercrime & Online Fraud',
    activeHelpline: '1930 / 022-22160080',
    isPinned: false
  }
];
